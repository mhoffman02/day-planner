/**
 * @file alpine.min.js
 * @description Vendored, minified third-party build of Alpine.js v3.16.1
 * (https://alpinejs.dev), pinned locally so the app doesn't depend on a CDN
 * at runtime. Not authored in this repo — do not hand-edit; replace the
 * whole file to upgrade. Excluded from linting/JSDoc coverage (see
 * eslint.config.js's `ignores` and tools/handoff.js's vendor-path skip in
 * autoFixFindings).
 */
