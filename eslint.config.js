 ...
 * server.js (Node scripts), tests/*.js, and gas-app/*.gs
...
export default [
  ...
  {
    ignores: ['node_modules/**', 'gas-app/vendor/**', 'src/vendor/**']
  },
  {
    files: ['src/**/*.js'],
    languageOptions: {
  ...
  },
  {
    ...
    // GAS runtime the other blocks above cover, so they need Node's own env globals.
    files: ['tests/**/*.js'],
    languageOptions: {
      ecmaVersion: 'latest',
      sourceType: 'module',
