...
- [x] **1. Create and Checkout Isolated Branch (`feat/modern-normalize`)**:
...
- [x] **2. Replace Pico CSS with `modern-normalize` & Baseline Styles**:
...
- [x] **3. Light & Dark Mode Parity & Regression Verification**:
